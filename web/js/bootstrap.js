...
+function($) {
    ...
    if (
        (version[0] < 2 && version[1] < 9) || (version[0] == 1 && version[1] == 9 && version[2] < 1)
        || (version[0] > 3)
    ) {
        throw new Error(
...
+function($) {
    ...
    function clearMenus(e) {
        ...
        $(toggle).each(function() {
            ...
            if (
                e && e.type == 'click' && /input|textarea/i.test(e.target.tagName)
    ...
    Dropdown.prototype.toggle = function(e) {
        ...
        if (!isActive) {
            if (
                'ontouchstart' in document.documentElement && !$parent.closest('.navbar-nav').length
            ) {
