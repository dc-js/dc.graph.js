            ...
            effect: function(/* effect, options, speed, callback */) {
                var args = _normalizeArguments.apply(this, arguments),
                    ...
                    prefilter = function(next) {
                        ...
                        if (
                            defaultMode && (normalizedMode === 'show'
   ...
   allowing multiple different settings on the same page. */
	 ...
	 */
        _enableDatepicker: function(target) {
            ...
            this._disabledInputs = $.map(
                this._disabledInputs, // Delete entry
                function(value) {
	 ...
	 */
        _optionDatepicker: function(target, name, value) {
            ...
            if (inst) {
                ...
                if (
                    minDate !== null && settings.dateFormat !== undefined
                    && settings.minDate === undefined
                ) {
                    inst.settings.minDate = this._formatDate(inst, minDate);
                }
                if (
                    maxDate !== null && settings.dateFormat !== undefined
	 ...
	 */
        ...
        _updateDatepicker: function(inst) {
            ...
            if (
                inst === $.datepicker._curInst && $.datepicker._datepickerShowing
        ...
        _findPos: function(obj) {
            ...
            while (
                obj && (obj.type === 'hidden' || obj.nodeType !== 1 || $.expr.pseudos.hidden(obj))
            ) {
	 ...
	 */
                    ...
                    if (literal) {
                        ...
                        switch (format.charAt(iFormat)) {
                            ...
                            case 'y':
                                output += lookAhead('y')
                                    ? date.getFullYear()
                                    : (date.getFullYear()%100 < 10 ? '0' : '')+date
                                                .getFullYear()%100;
                                break;
                            case '@':
                                output += date.getTime();
        ...
        _determineDate: function(inst, date, defaultDate) {
            var offsetNumeric = function(offset) {
                ...
                newDate = date == null || date === '' ? defaultDate : (typeof date === 'string'
                    ? offsetString(date)
                    : (typeof date === 'number'
	 ...
	 */
                    ...
                    for (dRow = 0; dRow < numRows; dRow++) { // create date picker rows
                        ...
                        for (dow = 0; dow < 7; dow++) { // create date picker days
                            ...
                            tbody += "<td class='"
                                ...
                                +(unselectable
                                    ? ''
                                    : " data-handler='selectDay' data-event='click' data-month='"+printDate
                                        .getMonth()
                                ...
                                +(otherMonth && !showOtherMonths
                                    ...
                                    : (unselectable
                                        ...
                                        : "<a class='ui-state-default"
                                            ...
                                            +"' href='#' aria-current='"+(printDate.getTime()
                                                    === currentDate.getTime()
                                                ? 'true'
        ...
        _generateMonthYearHeader: function(
            ...
            if (secondary || !changeMonth) {
                ...
                monthHtml +=
                    "<select class='ui-datepicker-month' aria-label='"+selectMonthLabel+"' data-handler='selectMonth' data-event='change'>";
            ...
            if (!inst.yearshtml) {
                ...
                if (secondary || !changeYear) {
                    ...
                    inst.yearshtml +=
                        "<select class='ui-datepicker-year' aria-label='"+selectYearLabel+"' data-handler='selectYear' data-event='change'>";
 ...
 */
    ...
    var plugin = $.ui.plugin = {
        ...
        call: function(instance, name, args, allowDisconnected) {
            ...
            if (
                !allowDisconnected && (!instance.element[0].parentNode
    ...
    $.widget('ui.dialog', {
        ...
        _createWrapper: function() {
            ...
            this._on(this.uiDialog, {
                keydown: function(event) {
                    if (
                        this.options.closeOnEscape && !event.isDefaultPrevented() && event.keyCode
    ...
    var widgetsSortable = $.widget('ui.sortable', $.ui.mouse, {
        ...
        _refreshItemPositions: function(fast) {
            ...
            for (i = this.items.length-1; i >= 0; i--) {
                ...
                if (
                    this.currentContainer && item.instance !== this.currentContainer
            ...
            if (!o.placeholder || o.placeholder.constructor === String) {
                ...
                o.placeholder = {
                    ...
                    update: function(container, p) {
                        ...
                        // is true.
                        if (
                            !p.height() || (o.forcePlaceholderSize
        ...
        _getParentOffset: function() {
            ...
            // offset of the parent, and never recalculated upon drag
            if (
                this.cssPosition === 'absolute' && this.scrollParent[0] !== this.document[0]
                && $.contains(this.scrollParent[0], this.offsetParent[0])
            ) {
                po.left += this.scrollParent.scrollLeft();
                po.top += this.scrollParent.scrollTop();
        ...
        _generatePosition: function(event) {
            ...
            if (
                this.cssPosition === 'relative' && !(this.scrollParent[0] !== this.document[0]
 ...
 */
    ...
    $.widget('ui.tooltip', {
        ...
        _updateContent: function(target, event) {
            ...
            if (
                typeof contentOption === 'string' || contentOption.nodeType
