...
(function(root, factory) {
    ...
    var computeLayout = (function() {
        ...
        function getLeadingPadding(node, axis) {
            if (
                node.style.paddingStart !== undefined && node.style.paddingStart >= 0
                && isRowDirection(axis)
            ) {
        ...
        function getTrailingPadding(node, axis) {
            if (
                node.style.paddingEnd !== undefined && node.style.paddingEnd >= 0
                && isRowDirection(axis)
            ) {
        ...
        function getLeadingBorder(node, axis) {
            if (
                node.style.borderStartWidth !== undefined && node.style.borderStartWidth >= 0
                && isRowDirection(axis)
            ) {
        ...
        function getTrailingBorder(node, axis) {
            if (
                node.style.borderEndWidth !== undefined && node.style.borderEndWidth >= 0
                && isRowDirection(axis)
            ) {
                                ...
                                if (isUndefined(child.layout[dim[crossAxis]])) {
                                    child.layout[dim[crossAxis]] = fmaxf(
                                        boundAxis(
                                            ...
                                            crossAxis,
                                            containerCrossAxis
                                                -paddingAndBorderAxisCross-getMarginAxis(
                                                    child,
                                                    crossAxis,
                                                ),
                                        ),
                ...
                for (i = 0; i < linesCount; ++i) {
                    ...
                    for (ii = startIndex; ii < endIndex; ++ii) {
                        ...
                        if (alignContentAlignItem === CSS_ALIGN_FLEX_START) {
                            ...
                            child.layout[pos[crossAxis]] =
                                currentLead+lineHeight-getTrailingMargin(child, crossAxis)-child
                                    .layout[dim[crossAxis]];
            ...
            while (currentAbsoluteChild !== null) {
                ...
                for (ii = 0; ii < 2; ii++) {
                    ...
                    if (
                        ...
                        currentAbsoluteChild.layout[leading[axis]] = node.layout[dim[axis]]
