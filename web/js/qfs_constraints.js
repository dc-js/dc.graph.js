var qfs_constraint_rules = {
    ...
    edges: [
        ...
        {source: 'Client', target: 'ChunkServer',
         produce: {
             axis: 'y',
             gap: 200,
             equality: true
         }},
        {source: 'Client', target: 'Attached Volume',
         produce: {
             axis: 'y',
             gap: 300,
             equality: true
         }},
        {source: 'Metaserver', target: 'Attached Volume',
         produce: {
             axis: 'y',
             gap: 200,
             equality: true
         }},
        {source: 'Metaserver', target: 'ChunkServer',
         produce: {
             axis: 'y',
             gap: 100,
             equality: true
         }},
        {source: 'ChunkServer', target: 'Attached Volume',
         produce: {
             axis: 'y',
             gap: 100,
             equality: true
