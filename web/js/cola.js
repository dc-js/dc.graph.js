    ...
    })()(
        {
                ...
                var D3StyleLayoutAdaptor = function(_super) {
                    ...
                    function D3StyleLayoutAdaptor() {
                        ...
                        _this.event = d3.dispatch(
                            layout_1.EventType[layout_1.EventType.start],
                            layout_1.EventType[layout_1.EventType.tick],
                            layout_1.EventType[layout_1.EventType.end],
                        );
                        var d3layout = _this;
                        var drag;
                        _this.drag = function() {
            ...
            7: [function(require, module, exports) {
                ...
                var Descent = function() {
                    ...
                    Descent.prototype.rungeKutta = function() {
                        ...
                        var disp = 0;
                        this.matrixApply(function(i, j) {
                            var x = (_this.a[i][j]+2.0*_this.b[i][j]+2.0*_this.c[i][j]+_this
                                    .d[i][j])/6.0,
                                d = _this.x[i][j]-x;
                            disp += d*d;
                            _this.x[i][j] = x;
            ...
            8: [function(require, module, exports) {
                ...
                function intersects(l, P) {
                    ...
                    for (var i = 1, n = P.length; i < n; ++i) {
                        var int = rectangle_1.Rectangle.lineIntersection(
                            l.x1,
                            l.y1,
                            l.x2,
                            l.y2,
            ...
            9: [function(require, module, exports) {
                ...
                var GridRouter = function() {
                    function GridRouter(originalnodes, accessor, groupPadding) {
                        ...
                        var frontToBackGroups = this.backToFront.slice(0).reverse().filter(
                            function(g) {
                                return !g.leaf;
                            },
                        );
                        ...
                        lines.forEach(function(l, li) {
                            _this.nodes.forEach(function(v, i) {
                                v.rect.lineIntersections(l.x1, l.y1, l.x2, l.y2).forEach(
                                    function(intersect, j) {
                                        var p = new Vert(
                                            _this.verts.length,
                                            intersect.x,
                                            intersect.y,
                    ...
                    GridRouter.prototype.route = function(s, t) {
                        ...
                        var shortestPathCalculator = new shortestpaths_1.Calculator(
                            this.verts.length,
                            this.passableEdges,
                            getSource,
                            getTarget,
                        ...
                        return pathPoints.filter(function(v, i) {
                            return !(i < pathPoints.length-1 && pathPoints[i+1].node === source
                                    && v.node === source
                                || i > 0 && v.node === target && pathPoints[i-1].node === target);
                        });
                    };
                    GridRouter.getRoutePath = function(
                        route,
                        cornerradius,
                        arrowwidth,
                        arrowheight,
                        ...
                        if (route.length > 1) {
                            for (var i = 0; i < route.length; i++) {
                                ...
                                if (i < route.length-1) {
                                    ...
                                    if (arrowheight > 0) {
                                        result.arrowpath =
                                            'M '+arrowtip[0]+' '+arrowtip[1]+' L '+arrowcorner1[
                                                0
                                            ]+' '+arrowcorner1[1]
                    ...
                    function put_rect(rect, max_width) {
                        ...
                        for (var i = 0; i < line.length; i++) {
                            if (
                                ...
                                && (line[i].x+line[i].width+rect.width+packingOptions
                                        .PADDING
                                        -max_width) <= packingOptions.FLOAT_EPSILON
                            ) {
                                parent = line[i];
                                break;
                            }
                ...
                var Layout = function() {
                    function Layout() {
                        ...
                        this.linkAccessor = {
                            ...
                            getType: function(l) {
                                return typeof _this._linkType === 'function'
                                    ? _this._linkType(l)
                                    : 0;
                            },
                        };
                    ...
                    Layout.prototype.flowLayout = function(axis, minSeparation) {
                        ...
                        this._directedLinkConstraints = {
                            axis: axis,
                            getMinSeparation: typeof minSeparation === 'number'
                                ? function() {
                    ...
                    Layout.prototype.symmetricDiffLinkLengths = function(idealLength, w) {
                        ...
                        this._linkLengthCalculator = function() {
                            return linklengths_1.symmetricDiffLinkLengths(
                                _this._links,
                                _this.linkAccessor,
                                w,
                            );
                    ...
                    Layout.prototype.jaccardLinkLengths = function(idealLength, w) {
                        ...
                        this._linkLengthCalculator = function() {
                            return linklengths_1.jaccardLinkLengths(
                                _this._links,
                                _this.linkAccessor,
                                w,
                            );
                    ...
                    Layout.prototype.start = function(
                        ...
                        var _this = this;
                        if (
                            initialUnconstrainedIterations === void 0
                        ) { initialUnconstrainedIterations = 0; }
                        if (
                            initialUserConstraintIterations === void 0
                        ) { initialUserConstraintIterations = 0; }
                        if (
                            initialAllConstraintsIterations === void 0
                    ...
                    Layout.prototype.separateOverlappingComponents = function(
                        width,
                        height,
                        centerGraph,
                    ) {
                        ...
                        if (!this._distanceMatrix && this._handleDisconnected) {
                            ...
                            var graphs = handledisconnected_1.separateGraphs(
                                this._nodes,
                                this._links,
                            );
                            handledisconnected_1.applyPacking(
                                graphs,
                                width,
                                height,
                    ...
                    Layout.prototype.routeEdge = function(edge, ah, draw) {
                        ...
                        var sourceInd = function(e) {
                            ...
                            spCalc = new shortestpaths_1.Calculator(
                                vg2.V.length,
                                vg2.E,
                                sourceInd,
                                targetInd,
                        ...
                        if (shortestPath.length === 1 || shortestPath.length === vg2.V.length) {
                            var route = rectangle_1.makeEdgeBetween(
            ...
            12: [function(require, module, exports) {
                ...
                var Layout3D = function() {
                    ...
                    Layout3D.prototype.start = function(iterations) {
                        ...
                        var distanceMatrix =
                            (new shortestpaths_1.Calculator(n, this.links, function(e) {
                                return e.source;
                            }, function(e) {
                                return e.target;
                            }, function(e) {
                        ...
                        this.descent.G = G;
                        if (this.constraints)
                            this.descent.project = new rectangle_1.Projection(
                                this.nodes,
                                null,
                                null,
                                this.constraints,
                ...
                var PairingHeap = function() {
                    ...
                    PairingHeap.prototype.mergePairs = function(lessThan) {
                        if (this.subheaps.length == 0)
                            ...
                            var firstPair = this.subheaps.pop().merge(
                                this.subheaps.pop(),
                                lessThan,
                            );
                    ...
                    PairingHeap.prototype.decreaseKey = function(
                        subheap,
                        newValue,
                        setHeapNode,
                        lessThan,
            ...
            17: [function(require, module, exports) {
                ...
                var Projection = function() {
                    ...
                    Projection.prototype.setupVariablesAndBounds = function(
                        x0,
                        y0,
                        desired,
                        getDesired,
            ...
            18: [function(require, module, exports) {
                ...
                var Calculator = function() {
                    ...
                    Calculator.prototype.PathFromNodeToNodeWithPrevCost = function(
                        start,
                        end,
                        prevCost,
                    ) {
