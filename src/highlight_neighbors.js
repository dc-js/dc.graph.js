...
export function highlightNeighbors(includeprops, excludeprops, neighborsgroup, thingsgroup) {
    const highlight_neighbors_group = registerHighlightNeighborsGroup(neighborsgroup || 'highlight-neighbors-group');
    const highlight_things_group = registerHighlightThingsGroup(thingsgroup || 'highlight-things-group');
